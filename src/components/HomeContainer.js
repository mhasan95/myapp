    ...
    return (
      <div className="HomeContainer" >
        <div class="row" style={{ padding: '2%'  }}>
            <div class="col-7">
            <Card style={{borderRadius:'15px',height:'75vh' }}>
            <Card.Body style={{marginLeft:'10px',marginRight:'11px',marginTop:'9px'}}>
                <Card.Title class="card_title" style={{textAlign : 'left',paddingBottom:'5px', zIndex:'1',position:'relative',width:'300px'}}><span style={{ borderBottom: '2px solid #ebf0f4'}}>Users</span></Card.Title>
                <Card.Text>
                <DataGrid style={{marginTop: '-40px'}}
            ...
            <div class="col-5">
            <Card style={{borderRadius:'15px',height:'75vh' }}>
            <i class="fab fa-facebook-f" height="50" width="50"></i> 
            <Card.Body style={{marginLeft:'10px',marginRight:'11px',marginTop:'9px'}}>
                <div class="row" >
                    <div class="col-12"  style={{textAlign : 'left'}}>
              ...
              <div class="row card_text_header" style={{paddingTop: '8%',textAlign : 'left' }}>
                  ...
                  <div class="col-md-12" >
                      <div class="rowlayout">
                          <div class="col-sm-3">
                              <a class="links" href="#" style={{marginLeft:'-13px'}}>
                                  User Id
                              </a>
                          </div>
                          <div class="col-9">
                              <div class="rowspacing">{this.state.id}</div>
                  ...
                  <div class="col-md-12" style={{paddingTop: '5%'}}>
                      <div class="rowlayout">
                          ...
                          <div class="col-6">
                              <div class="rowspacing">{this.state.name}</div>
                  ...
                  <div class="col-md-12" style={{paddingTop: '5%'}}>
                      <div class="rowlayout">
                          ...
                          <div class="col-md-6">
                              <div class="rowspacing">{this.state.Gender}</div>
                  ...
                  <div class="col-md-12" style={{paddingTop: '5%'}}>
                      <div class="rowlayout">
                          ...
                          <div class="col-6">
                              <div class="rowspacing">{this.state.Register }</div>
                ...
                <div class="xxl-6 col-md-12" style={{paddingTop: '5%'}}>
                    <div class="rowlayout" style= {{border:'none'}}>
                        <div class="col-sm-2">
                            <a class="links" href="#" style={{marginLeft:'-13px'}}>
                                Surveys
                            </a>
                        ...
                        <div class="col-10">
                        <div class="rowspacing" >{this.state.surveys}</div>           
                ...
                <div class="col-md-12" style={{paddingTop: '5%'}}>
                    <div class="rowlayout">
                        ...
                        <div class="col-8">
                            <div class="rowspacing">{this.state.email}</div>
